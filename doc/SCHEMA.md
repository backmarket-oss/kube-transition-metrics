...
- [1. Property `Metric Record > kube_transition_metrics`](#kube_transition_metrics)
  ...
  - [1.6. Property `Metric Record > kube_transition_metrics > kube_node`](#kube_transition_metrics_kube_node)
  - [1.7. Property `Metric Record > kube_transition_metrics > kube_qos`](#kube_transition_metrics_kube_qos)
  - [1.8. Property `Metric Record > kube_transition_metrics > kube_priority_class`](#kube_transition_metrics_kube_priority_class)
  - [1.9. Property `Metric Record > kube_transition_metrics > kube_runtime_class`](#kube_transition_metrics_kube_runtime_class)
  - [1.10. Property `Metric Record > kube_transition_metrics > kube_ownerref_kind`](#kube_transition_metrics_kube_ownerref_kind)
  - [1.11. Property `Metric Record > kube_transition_metrics > kube_ownerref_name`](#kube_transition_metrics_kube_ownerref_name)
  - [1.12. Property `Metric Record > kube_transition_metrics > kube_cronjob`](#kube_transition_metrics_kube_cronjob)
  - [1.13. Property `Metric Record > kube_transition_metrics > kube_daemon_set`](#kube_transition_metrics_kube_daemon_set)
  - [1.14. Property `Metric Record > kube_transition_metrics > kube_deployment`](#kube_transition_metrics_kube_deployment)
  - [1.15. Property `Metric Record > kube_transition_metrics > kube_job`](#kube_transition_metrics_kube_job)
  - [1.16. Property `Metric Record > kube_transition_metrics > kube_replica_set`](#kube_transition_metrics_kube_replica_set)
  - [1.17. Property `Metric Record > kube_transition_metrics > kube_statefulset`](#kube_transition_metrics_kube_statefulset)
  - [1.18. Property `Metric Record > kube_transition_metrics > kube_service`](#kube_transition_metrics_kube_service)
  - [1.19. Property `Metric Record > kube_transition_metrics > kube_app_component`](#kube_transition_metrics_kube_app_component)
  - [1.20. Property `Metric Record > kube_transition_metrics > kube_app_instance`](#kube_transition_metrics_kube_app_instance)
  - [1.21. Property `Metric Record > kube_transition_metrics > kube_app_managed_by`](#kube_transition_metrics_kube_app_managed_by)
  - [1.22. Property `Metric Record > kube_transition_metrics > kube_app_name`](#kube_transition_metrics_kube_app_name)
  - [1.23. Property `Metric Record > kube_transition_metrics > kube_app_part_of`](#kube_transition_metrics_kube_app_part_of)
  - [1.24. Property `Metric Record > kube_transition_metrics > kube_app_version`](#kube_transition_metrics_kube_app_version)
  - [1.25. Property `Metric Record > kube_transition_metrics > container_name`](#kube_transition_metrics_container_name)
  - [1.26. Property `Metric Record > kube_transition_metrics > short_image`](#kube_transition_metrics_short_image)
  - [1.27. Property `Metric Record > kube_transition_metrics > image_name`](#kube_transition_metrics_image_name)
  - [1.28. Property `Metric Record > kube_transition_metrics > image_tag`](#kube_transition_metrics_image_tag)
  - [1.29. Property `Metric Record > kube_transition_metrics > pod`](#kube_transition_metrics_pod)
    - [1.29.1. Property `Metric Record > kube_transition_metrics > pod > creation_timestamp`](#kube_transition_metrics_pod_creation_timestamp)
    - [1.29.2. Property `Metric Record > kube_transition_metrics > pod > scheduled_timestamp`](#kube_transition_metrics_pod_scheduled_timestamp)
    - [1.29.3. Property `Metric Record > kube_transition_metrics > pod > creation_to_scheduled_seconds`](#kube_transition_metrics_pod_creation_to_scheduled_seconds)
    - [1.29.4. Property `Metric Record > kube_transition_metrics > pod > initialized_timestamp`](#kube_transition_metrics_pod_initialized_timestamp)
    - [1.29.5. Property `Metric Record > kube_transition_metrics > pod > creation_to_initialized_seconds`](#kube_transition_metrics_pod_creation_to_initialized_seconds)
    - [1.29.6. Property `Metric Record > kube_transition_metrics > pod > scheduled_to_initialized_seconds`](#kube_transition_metrics_pod_scheduled_to_initialized_seconds)
    - [1.29.7. Property `Metric Record > kube_transition_metrics > pod > ready_timestamp`](#kube_transition_metrics_pod_ready_timestamp)
    - [1.29.8. Property `Metric Record > kube_transition_metrics > pod > creation_to_ready_seconds`](#kube_transition_metrics_pod_creation_to_ready_seconds)
    - [1.29.9. Property `Metric Record > kube_transition_metrics > pod > initialized_to_ready_seconds`](#kube_transition_metrics_pod_initialized_to_ready_seconds)
  - [1.30. Property `Metric Record > kube_transition_metrics > container`](#kube_transition_metrics_container)
    - [1.30.1. Property `Metric Record > kube_transition_metrics > container > init_container`](#kube_transition_metrics_container_init_container)
    - [1.30.2. Property `Metric Record > kube_transition_metrics > container > previous_to_running_seconds`](#kube_transition_metrics_container_previous_to_running_seconds)
    - [1.30.3. Property `Metric Record > kube_transition_metrics > container > initialized_to_running_seconds`](#kube_transition_metrics_container_initialized_to_running_seconds)
    - [1.30.4. Property `Metric Record > kube_transition_metrics > container > running_timestamp`](#kube_transition_metrics_container_running_timestamp)
    - [1.30.5. Property `Metric Record > kube_transition_metrics > container > started_timestamp`](#kube_transition_metrics_container_started_timestamp)
    - [1.30.6. Property `Metric Record > kube_transition_metrics > container > running_to_started_seconds`](#kube_transition_metrics_container_running_to_started_seconds)
    - [1.30.7. Property `Metric Record > kube_transition_metrics > container > ready_timestamp`](#kube_transition_metrics_container_ready_timestamp)
    - [1.30.8. Property `Metric Record > kube_transition_metrics > container > running_to_ready_seconds`](#kube_transition_metrics_container_running_to_ready_seconds)
    - [1.30.9. Property `Metric Record > kube_transition_metrics > container > started_to_ready_seconds`](#kube_transition_metrics_container_started_to_ready_seconds)
  - [1.31. Property `Metric Record > kube_transition_metrics > image_pull`](#kube_transition_metrics_image_pull)
    - [1.31.1. Property `Metric Record > kube_transition_metrics > image_pull > already_present`](#kube_transition_metrics_image_pull_already_present)
    - [1.31.2. Property `Metric Record > kube_transition_metrics > image_pull > started_timestamp`](#kube_transition_metrics_image_pull_started_timestamp)
    - [1.31.3. Property `Metric Record > kube_transition_metrics > image_pull > finished_timestamp`](#kube_transition_metrics_image_pull_finished_timestamp)
    - [1.31.4. Property `Metric Record > kube_transition_metrics > image_pull > duration_seconds`](#kube_transition_metrics_image_pull_duration_seconds)
...
### <a name="kube_transition_metrics_kube_node"></a>1.6. Property `Metric Record > kube_transition_metrics > kube_node`
...
### <a name="kube_transition_metrics_kube_qos"></a>1.7. Property `Metric Record > kube_transition_metrics > kube_qos`
...
### <a name="kube_transition_metrics_kube_priority_class"></a>1.8. Property `Metric Record > kube_transition_metrics > kube_priority_class`
...
### <a name="kube_transition_metrics_kube_runtime_class"></a>1.9. Property `Metric Record > kube_transition_metrics > kube_runtime_class`
...
### <a name="kube_transition_metrics_kube_ownerref_kind"></a>1.10. Property `Metric Record > kube_transition_metrics > kube_ownerref_kind`
...
### <a name="kube_transition_metrics_kube_ownerref_name"></a>1.11. Property `Metric Record > kube_transition_metrics > kube_ownerref_name`
...
### <a name="kube_transition_metrics_kube_cronjob"></a>1.12. Property `Metric Record > kube_transition_metrics > kube_cronjob`
...
### <a name="kube_transition_metrics_kube_daemon_set"></a>1.13. Property `Metric Record > kube_transition_metrics > kube_daemon_set`
...
### <a name="kube_transition_metrics_kube_deployment"></a>1.14. Property `Metric Record > kube_transition_metrics > kube_deployment`
...
### <a name="kube_transition_metrics_kube_job"></a>1.15. Property `Metric Record > kube_transition_metrics > kube_job`
...
### <a name="kube_transition_metrics_kube_replica_set"></a>1.16. Property `Metric Record > kube_transition_metrics > kube_replica_set`
...
### <a name="kube_transition_metrics_kube_statefulset"></a>1.17. Property `Metric Record > kube_transition_metrics > kube_statefulset`
...
### <a name="kube_transition_metrics_kube_service"></a>1.18. Property `Metric Record > kube_transition_metrics > kube_service`
...
### <a name="kube_transition_metrics_kube_app_component"></a>1.19. Property `Metric Record > kube_transition_metrics > kube_app_component`
...
### <a name="kube_transition_metrics_kube_app_instance"></a>1.20. Property `Metric Record > kube_transition_metrics > kube_app_instance`
...
### <a name="kube_transition_metrics_kube_app_managed_by"></a>1.21. Property `Metric Record > kube_transition_metrics > kube_app_managed_by`
...
### <a name="kube_transition_metrics_kube_app_name"></a>1.22. Property `Metric Record > kube_transition_metrics > kube_app_name`
...
### <a name="kube_transition_metrics_kube_app_part_of"></a>1.23. Property `Metric Record > kube_transition_metrics > kube_app_part_of`
...
### <a name="kube_transition_metrics_kube_app_version"></a>1.24. Property `Metric Record > kube_transition_metrics > kube_app_version`
...
### <a name="kube_transition_metrics_container_name"></a>1.25. Property `Metric Record > kube_transition_metrics > container_name`
...
### <a name="kube_transition_metrics_short_image"></a>1.26. Property `Metric Record > kube_transition_metrics > short_image`
...
### <a name="kube_transition_metrics_image_name"></a>1.27. Property `Metric Record > kube_transition_metrics > image_name`
...
### <a name="kube_transition_metrics_image_tag"></a>1.28. Property `Metric Record > kube_transition_metrics > image_tag`
...
### <a name="kube_transition_metrics_pod"></a>1.29. Property `Metric Record > kube_transition_metrics > pod`
...
#### <a name="kube_transition_metrics_pod_creation_timestamp"></a>1.29.1. Property `Metric Record > kube_transition_metrics > pod > creation_timestamp`
...
#### <a name="kube_transition_metrics_pod_scheduled_timestamp"></a>1.29.2. Property `Metric Record > kube_transition_metrics > pod > scheduled_timestamp`
...
#### <a name="kube_transition_metrics_pod_creation_to_scheduled_seconds"></a>1.29.3. Property `Metric Record > kube_transition_metrics > pod > creation_to_scheduled_seconds`
...
#### <a name="kube_transition_metrics_pod_initialized_timestamp"></a>1.29.4. Property `Metric Record > kube_transition_metrics > pod > initialized_timestamp`
...
#### <a name="kube_transition_metrics_pod_creation_to_initialized_seconds"></a>1.29.5. Property `Metric Record > kube_transition_metrics > pod > creation_to_initialized_seconds`
...
#### <a name="kube_transition_metrics_pod_scheduled_to_initialized_seconds"></a>1.29.6. Property `Metric Record > kube_transition_metrics > pod > scheduled_to_initialized_seconds`
...
#### <a name="kube_transition_metrics_pod_ready_timestamp"></a>1.29.7. Property `Metric Record > kube_transition_metrics > pod > ready_timestamp`
...
#### <a name="kube_transition_metrics_pod_creation_to_ready_seconds"></a>1.29.8. Property `Metric Record > kube_transition_metrics > pod > creation_to_ready_seconds`
...
#### <a name="kube_transition_metrics_pod_initialized_to_ready_seconds"></a>1.29.9. Property `Metric Record > kube_transition_metrics > pod > initialized_to_ready_seconds`
...
### <a name="kube_transition_metrics_container"></a>1.30. Property `Metric Record > kube_transition_metrics > container`
...
#### <a name="kube_transition_metrics_container_init_container"></a>1.30.1. Property `Metric Record > kube_transition_metrics > container > init_container`
...
#### <a name="kube_transition_metrics_container_previous_to_running_seconds"></a>1.30.2. Property `Metric Record > kube_transition_metrics > container > previous_to_running_seconds`
...
#### <a name="kube_transition_metrics_container_initialized_to_running_seconds"></a>1.30.3. Property `Metric Record > kube_transition_metrics > container > initialized_to_running_seconds`
...
#### <a name="kube_transition_metrics_container_running_timestamp"></a>1.30.4. Property `Metric Record > kube_transition_metrics > container > running_timestamp`
...
#### <a name="kube_transition_metrics_container_started_timestamp"></a>1.30.5. Property `Metric Record > kube_transition_metrics > container > started_timestamp`
...
#### <a name="kube_transition_metrics_container_running_to_started_seconds"></a>1.30.6. Property `Metric Record > kube_transition_metrics > container > running_to_started_seconds`
...
#### <a name="kube_transition_metrics_container_ready_timestamp"></a>1.30.7. Property `Metric Record > kube_transition_metrics > container > ready_timestamp`
...
#### <a name="kube_transition_metrics_container_running_to_ready_seconds"></a>1.30.8. Property `Metric Record > kube_transition_metrics > container > running_to_ready_seconds`
...
#### <a name="kube_transition_metrics_container_started_to_ready_seconds"></a>1.30.9. Property `Metric Record > kube_transition_metrics > container > started_to_ready_seconds`
...
### <a name="kube_transition_metrics_image_pull"></a>1.31. Property `Metric Record > kube_transition_metrics > image_pull`
...
#### <a name="kube_transition_metrics_image_pull_already_present"></a>1.31.1. Property `Metric Record > kube_transition_metrics > image_pull > already_present`
...
#### <a name="kube_transition_metrics_image_pull_started_timestamp"></a>1.31.2. Property `Metric Record > kube_transition_metrics > image_pull > started_timestamp`
...
#### <a name="kube_transition_metrics_image_pull_finished_timestamp"></a>1.31.3. Property `Metric Record > kube_transition_metrics > image_pull > finished_timestamp`
...
#### <a name="kube_transition_metrics_image_pull_duration_seconds"></a>1.31.4. Property `Metric Record > kube_transition_metrics > image_pull > duration_seconds`
